...
<section class="summary">
  <h2>Totals</h2>
  <table>
    <tr><th>{content_label}</th><td>{total_uploads:,}</td></tr>
    <tr><th>Total views</th><td>{total_views:,}</td></tr>
  </table>
</section>

<footer class="footer">
  Generated by <a href="https://github.com/ThoriaDev/Kleos">Kleos</a> on {timestamp}
</footer>
